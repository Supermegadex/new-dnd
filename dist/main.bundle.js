...
var AppComponent = AppComponent_1 = (function () {
    ...
    AppComponent.prototype.getStat = function (stat) {
    ...
    AppComponent.prototype.addPoint = function (stat) {
        if (this.points > 0) {
            this.character.mod[stat]++;
            this.points--;
        }
    };
    AppComponent.prototype.subtractPoint = function (stat) {
        if (this.points < 6) {
            this.character.mod[stat]--;
            this.points++;
        }
    ...
    AppComponent.prototype.pickRace = function (name) {
        ...
        this.showChar = true;
        var nameTab = document.querySelector(".mat-tab-label:nth-child(2)");
        nameTab.click();
    };
    AppComponent.prototype.chooseName = function () {
        var statsTab = document.querySelector(".mat-tab-label:nth-child(3)");
        statsTab.click();
    };
    return AppComponent;
}());
AppComponent = AppComponent_1 = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_2__angular_material__["g" /* MdTabGroup */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["g" /* MdTabGroup */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_material__["g" /* MdTabGroup */]) === "function" && _a || Object])
], AppComponent);
        ...
        this.races = [
            // Human Race
            {
                ...
                karma: function (karmaRoll) {
                    ...
                    var hr = localStorage.getItem("humanRoll");
                    switch (hr) {
                        case "1":
